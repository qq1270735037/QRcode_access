    ...
    <view class="serach">
        <view class="content" :style="{ 'border-radius': radius + 'px' }">
            <view class="content-box">
                ...
                <view class="seach-select" v-if="selectList.length>0">
                    ...
                    <view class="select-item-list" :style="{'display':(showSelectList)?'block':'none'}">
                        <text class="cuIcon-triangleupfill"
                            style="position: absolute;top: -18px;left: 60rpx;font-size: 40rpx;color: #FFFFFF;"></text>
                ...
                <text v-if="isDelShow" class="cuIcon-roundclose" style="margin-right: 10upx;" @tap.stop="clear"></text>
            </view>
            <view v-if="
					(showSeachBth && button === 'inside') ||
						(isDelShow && button === 'inside')
				" class="serachBtn" style="background-color: #4148c0;color: #fff;" @tap="search">
                搜索
            </view>
        </view>
